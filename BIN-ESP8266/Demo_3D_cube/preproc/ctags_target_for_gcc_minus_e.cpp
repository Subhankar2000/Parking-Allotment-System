# 1 "C:\\Users\\Subhankar Karmakar\\Documents\\Arduino\\libraries\\TFT_eSPI\\examples\\480 x 320\\Demo_3D_cube\\Demo_3D_cube.ino"
/*
...
# 17 "C:\\Users\\Subhankar Karmakar\\Documents\\Arduino\\libraries\\TFT_eSPI\\examples\\480 x 320\\Demo_3D_cube\\Demo_3D_cube.ino" 2

# 19 "C:\\Users\\Subhankar Karmakar\\Documents\\Arduino\\libraries\\TFT_eSPI\\examples\\480 x 320\\Demo_3D_cube\\Demo_3D_cube.ino" 2
...
void RenderImage( void)
{
  ...
  {
    tft.drawLine(ORender[i].p0.x, ORender[i].p0.y, ORender[i].p1.x, ORender[i].p1.y, 0x0000); // erase the old lines.
  }


  for (int i = 0; i < LinestoRender; i++ )
  {
    uint16_t color = 0x001F /*   0,   0, 255 */;
    if (i < 4) color = 0xF800 /* 255,   0,   0 */;
    if (i > 7) color = 0x07E0 /*   0, 255,   0 */;
