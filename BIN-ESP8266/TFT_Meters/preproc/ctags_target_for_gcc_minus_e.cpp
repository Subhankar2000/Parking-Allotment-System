# 1 "D:\\Arduino-STM32-ARM-M4\\portable\\sketchbook\\libraries\\TFT_eSPI\\examples\\320 x 240\\TFT_Meters\\TFT_Meters.ino"
# 1 "D:\\Arduino-STM32-ARM-M4\\portable\\sketchbook\\libraries\\TFT_eSPI\\examples\\320 x 240\\TFT_Meters\\TFT_Meters.ino"
/*
...
# 15 "D:\\Arduino-STM32-ARM-M4\\portable\\sketchbook\\libraries\\TFT_eSPI\\examples\\320 x 240\\TFT_Meters\\TFT_Meters.ino" 2
# 16 "D:\\Arduino-STM32-ARM-M4\\portable\\sketchbook\\libraries\\TFT_eSPI\\examples\\320 x 240\\TFT_Meters\\TFT_Meters.ino" 2
...
void loop() {
  if (updateTime <= millis()) {
    updateTime = millis() + 35 /* Display updates every 35 ms*/;
...
{
  // Meter outline
  tft.fillRect(0, 0, 239, 126, 0x5AEB);
  tft.fillRect(5, 3, 230, 119, 0xFFFF /* 255, 255, 255 */);
  ...
  tft.drawRect(5, 3, 230, 119, 0x0000 /*   0,   0,   0 */); // Draw bezel line
...
void plotNeedle(int value, byte ms_delay)
{
  ...
  while (!(value == old_analog)) {
    ...
    tft.drawLine(120 + 20 * ltx - 1, 140 - 20, osx - 1, osy, 0xFFFF /* 255, 255, 255 */);
    tft.drawLine(120 + 20 * ltx, 140 - 20, osx, osy, 0xFFFF /* 255, 255, 255 */);
    tft.drawLine(120 + 20 * ltx + 1, 140 - 20, osx + 1, osy, 0xFFFF /* 255, 255, 255 */);
    ...
    tft.drawLine(120 + 20 * ltx - 1, 140 - 20, osx - 1, osy, 0xF800 /* 255,   0,   0 */);
    tft.drawLine(120 + 20 * ltx, 140 - 20, osx, osy, 0xF81F /* 255,   0, 255 */);
    tft.drawLine(120 + 20 * ltx + 1, 140 - 20, osx + 1, osy, 0xF800 /* 255,   0,   0 */);
...
{
  int w = 36;
  tft.drawRect(x, y, w, 155, 0x5AEB);
  tft.fillRect(x + 2, y + 19, w - 3, 155 - 38, 0xFFFF /* 255, 255, 255 */);
  tft.setTextColor(0x07FF /*   0, 255, 255 */, 0x0000 /*   0,   0,   0 */);
  tft.drawCentreString(label, x + w / 2, y + 2, 2);

  for (int i = 0; i < 110; i += 10)
  {
    tft.drawFastHLine(x + 20, y + 27 + i, 6, 0x0000 /*   0,   0,   0 */);
  }

  for (int i = 0; i < 110; i += 50)
  {
    tft.drawFastHLine(x + 20, y + 27 + i, 9, 0x0000 /*   0,   0,   0 */);
  }

  tft.fillTriangle(x + 3, y + 127, x + 3 + 16, y + 127, x + 3, y + 127 - 5, 0xF800 /* 255,   0,   0 */);
  tft.fillTriangle(x + 3, y + 127, x + 3 + 16, y + 127, x + 3, y + 127 + 5, 0xF800 /* 255,   0,   0 */);
...
void plotPointer(void)
{
  ...
  for (int i = 0; i < 6; i++)
  {
    ...
    while (!(value[i] == old_value[i])) {
      ...
      {
        tft.drawLine(dx, dy - 5, dx + pw, dy, 0xFFFF /* 255, 255, 255 */);
        old_value[i]--;
        tft.drawLine(dx, dy + 6, dx + pw, dy + 1, 0xF800 /* 255,   0,   0 */);
      }
      else
      {
        tft.drawLine(dx, dy + 5, dx + pw, dy, 0xFFFF /* 255, 255, 255 */);
