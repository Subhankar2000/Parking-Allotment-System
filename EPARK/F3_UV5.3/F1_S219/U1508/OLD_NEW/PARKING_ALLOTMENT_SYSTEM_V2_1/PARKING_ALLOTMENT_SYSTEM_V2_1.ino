...
void setup(void)
{
  ...
  */
  ...
  if ( screen == 1111 ) {
    ...
    Serial1.print(c[i][counter[i]].ph_number[0]) ;
    Serial1.print(c[i][counter[i]].ph_number[1]) ;
    Serial1.print(c[i][counter[i]].ph_number[2]) ;
    Serial1.print(c[i][counter[i]].ph_number[3]) ;
    Serial1.print(c[i][counter[i]].ph_number[4]) ;
    Serial1.print(c[i][counter[i]].ph_number[5]) ;
    Serial1.print(c[i][counter[i]].ph_number[6]) ;
    Serial1.print(c[i][counter[i]].ph_number[7]) ;
    Serial1.print(c[i][counter[i]].ph_number[8]) ;
    Serial1.print(c[i][counter[i]].ph_number[9]) ;
    Serial1.print("\"\r") ;
    Serial1.println() ;
    delay(1000) ;
    Serial1.println("--- E-RECEIPT ---") ;
    Serial1.println("") ;
    Serial1.println("PARKING ALLOTMENT SYSTEM") ;
    Serial1.println("VEHICLE ENTRY") ;
    Serial1.println("") ;
    Serial1.print("PIN : ") ;
    Serial1.print(c[i][counter[i]].number[0]);
    Serial1.print(c[i][counter[i]].number[1]);
    Serial1.print(c[i][counter[i]].number[2]);
    Serial1.print(c[i][counter[i]].number[3]);
    Serial1.println("") ;
    Serial1.print("FLOOR : ") ;
    if ( c[i][counter[i]].slot == 0 )
      Serial1.print("GROUND FLOOR") ;
    else if ( c[i][counter[i]].slot == 1 )
      Serial1.print("1st FLOOR") ;
    else if ( c[i][counter[i]].slot == 2 )
      Serial1.print("2nd FLOOR") ;
    else if ( c[i][counter[i]].slot == 3 )
      Serial1.print("3rd FLOOR") ;
    Serial1.println("") ;
    Serial1.print("TYPE : ") ;
    if ( c[i][counter[i]].type == 1 )
      ...
      Serial1.print("CAR") ;
    Serial1.println("");
    Serial1.print("ENTRY TIME : ");
    Serial1.println(rtc.getTimeStr());
    Serial1.println("") ;
    Serial1.print("DATE : ") ;
    Serial1.println(rtc.getDateStr()) ;
    Serial1.println("");
    delay(100);
  ...
  if ( screen == 8341 ) {
    ...
    Serial1.println(rtc.getTimeStr());
    Serial1.println("");
    Serial1.print("CARS WENT OUT OF PARKING SPACE : ");
    Serial1.print(C_OUT) ;
    Serial1.println("");
    Serial1.print("TOTAL AMOUNT COLLECTED : ");
    Serial1.print(COST) ;
    Serial1.println("");
    Serial1.print("CARS STILL IN PARKING SPACE : ");
    Serial1.print(C_IN) ;
    Serial1.println("");
  ...
  if ( screen == 4 ) {
    ...
    E.initButton(&tft,  160 , 210 + 20, 110, 50, WHITE, ILI9481_ORANGE, WHITE, "Numpad", 2);
  ...
  if ( screen == 22) {
    ...
    */
    ...
    if (c[i_temp][j_temp].yes == 1 ) {
      ...
      delay(1000) ;
      Serial1.print("AT+CMGS=\"+91") ;
      Serial1.print(c[i_temp][j_temp].ph_number[0]) ;
      Serial1.print(c[i_temp][j_temp].ph_number[1]) ;
      Serial1.print(c[i_temp][j_temp].ph_number[2]) ;
      Serial1.print(c[i_temp][j_temp].ph_number[3]) ;
      Serial1.print(c[i_temp][j_temp].ph_number[4]) ;
      Serial1.print(c[i_temp][j_temp].ph_number[5]) ;
      Serial1.print(c[i_temp][j_temp].ph_number[6]) ;
      Serial1.print(c[i_temp][j_temp].ph_number[7]) ;
      Serial1.print(c[i_temp][j_temp].ph_number[8]) ;
      Serial1.print(c[i_temp][j_temp].ph_number[9]) ;
      Serial1.print("\"\r") ;
      Serial1.println() ;
      delay(1000) ;
      Serial1.println("--- E-RECEIPT ---") ;
      Serial1.println("") ;
      Serial1.println("PARKING ALLOTMENT SYSTEM") ;
      Serial1.println("VEHICLE EXIT") ;
      Serial1.println("") ;
      Serial1.print("TIME KEPT : ") ;
      Serial1.print(T1) ;
      Serial1.println("") ;
      Serial1.print("AMOUNT TO BE PAID : ") ;
      if ( c[i_temp][j_temp].type == 1 )
        Serial1.print("Rs. 25") ;
      else if ( c[i_temp][j_temp].type == 2 )
        Serial1.print("Rs. 30") ;
      Serial1.println("");
      Serial1.print("EXIT TIME : ");
      Serial1.println(rtc.getTimeStr());
      Serial1.println("") ;
      Serial1.print("DATE : ") ;
      Serial1.println(rtc.getDateStr()) ;
