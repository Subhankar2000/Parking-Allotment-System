...
uint16_t buttoncolors[15] = {ILI9481_DARKGREEN, ILI9481_DARKGREY, ILI9481_RED,
...
void status(const __FlashStringHelper *msg) {
  tft.fillRect(STATUS_X, STATUS_Y, 240, 8, ILI9481_BLACK);
 ...
 */
  ...
  if ( screen == 5 ) {
    ...
    Finish.initButton(&tft,  160 , 300, 150, 50, BLACK, ILI9481_GREEN, BLACK, "Finish", 3);
    Back.initButton(&tft,  41, 460, 80, 30, ILI9481_RED, ILI9481_RED, WHITE, "Back", 2);
