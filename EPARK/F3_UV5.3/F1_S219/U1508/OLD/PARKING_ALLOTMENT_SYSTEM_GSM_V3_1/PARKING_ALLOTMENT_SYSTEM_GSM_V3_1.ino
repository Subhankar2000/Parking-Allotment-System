...
void setup(void)
{
  ...
  */
  ...
  if ( screen == 4 ) {
    ...
    showmsgXYM(1, 133, 1, &FreeSans9pt7b, "Enter 4 digit PIN to make it unique , it should consist of last 2 digits of your vehicle number and two secret digits of your choice") ;
    ...
    if ( n == 1 ) {
      ...
      showmsgXYM(17, 400, 1, &FreeSans9pt7b, "Press Confirm");
  ...
  if ( screen == 45 ) {
    ...
    /* -- showmsgXYM(1, 133, 1, &FreeSans9pt7b, "Enter your Vehicle's Registration no.     (from number plate) for our records") ; -- */
    showmsgXYM(1, 133, 1, &FreeSans9pt7b, "Enter your 10 DIGIT phone number , which you have right now") ;
    /*  EXECUTE THESE STATEMENTS AFTER RETURNING FROM NUMPAD SCREEN */
    if ( n == 1 ) {
      showmsgXY(50 + 8, 260 + 14, 2 , NULL , textfield) ;
      tft.drawRect(50, 260, 220, 50, ILI9481_DARKGREY );
  ...
  if ( screen == 5 ) {
    C_IN = C_IN + (counter[0] + counter[1] + counter[2] + counter[3]) ;
  ...
  if ( screen == 21) {
    ...
    showmsgXYM(1, 133, 1, &FreeSans9pt7b, "Enter the 4-digit PIN, to take your vehicle out") ;
      ...
      if (buttons[b].justPressed()) {
        ...
        if (b >= 3) {
          if (ph_textfield_i < ph_TEXT_LEN) {
            ...
            ph_textfield_i++;
            ph_textfield[textfield_i] = 0; // zero terminate
          }
        }
