/*
  Flappy Bird Game using 3.5" TFT LCD Arduino Module 
  UTFT_480x320_ili9481

 created 2017
 by Sugumaran Pravin Kumar
...
void initiateGame() {
  ...
  myGLCD.print("Flappy Bird", 300, 300); 
  myGLCD.setColor(0, 0, 0);
