/*   EPARK CORTEX S5 [ MINI / GSM / SERVER(b) ] <----------------------------------------------------------------------------------> [ V1 / V5 / V5.3(b) ]
     ...
     WITH AN ANDROID APP FOR PRE-BOOKING AND VIEWING OF SLOTS. [ NOT IMPLEMENTED ]                                                                 [V5.3]
...
/* FOR SD CARD WITHIN THE TFT SHIELD */
#include <SPI.h>
#include <SD.h>
/* USE THE OFFICIAL SD LIBRARY WITH HARDWARE PINS */
#if defined(ESP32)
#define SD_CS     5
#else
#define SD_CS     10
...
/*  THERE ARE MULTIPLE NUMPADS IN THE CODE */
#define BUTTON_X 75
#define BUTTON_Y 120
#define BUTTON_W 60
#define BUTTON_H 45
...
/*--------------- EXTERNAL FUNCTIONS FOR READING IMAGE FROM SD CARD --------------------*/
