#include <Arduino.h>
#line 1 "C:\\Users\\SUBHAN~2\\AppData\\Local\\Temp\\arduino_modified_sketch_789063\\drawBitmap_kbv.ino"
#line 1 "C:\\Users\\SUBHAN~2\\AppData\\Local\\Temp\\arduino_modified_sketch_789063\\drawBitmap_kbv.ino"
...
#line 20 "C:\\Users\\SUBHAN~2\\AppData\\Local\\Temp\\arduino_modified_sketch_789063\\drawBitmap_kbv.ino"
void setup();
#line 82 "C:\\Users\\SUBHAN~2\\AppData\\Local\\Temp\\arduino_modified_sketch_789063\\drawBitmap_kbv.ino"
void msg_time(int x, int y, String msg, uint32_t t);
#line 91 "C:\\Users\\SUBHAN~2\\AppData\\Local\\Temp\\arduino_modified_sketch_789063\\drawBitmap_kbv.ino"
void loop(void);
#line 20 "C:\\Users\\SUBHAN~2\\AppData\\Local\\Temp\\arduino_modified_sketch_789063\\drawBitmap_kbv.ino"
void setup()
{
    ...
    Serial6.print(F("ID = 0x"));
    Serial6.println(ID, HEX);

    Serial6.println(F("GFX drawBitmap() plots one mono pixel at a time"));
    Serial6.println(F("it defaults to transparent plotting"));
    Serial6.println(F("unless you specify foreground and background colours"));
    Serial6.println(F("it can plot a monochrome bitmap from Flash or SRAM"));

    Serial6.println(F(""));
    Serial6.println(F("GFX drawGrayscaleBitmap() is not relevant for OLED, TFT"));
    Serial6.println(F("GFX drawRGBBitmap() plots one colour pixel at a time"));
    Serial6.println(F("from Flash or SRAM and with a monochrome transparent bitmask"));
    Serial6.println(F(""));
    Serial6.println(F("Using the hardware pushColors() methods is faster"));
    Serial6.println(F("pushColors() expects uint16 array in SRAM"));
    Serial6.println(F("for any runtime generated images"));
    Serial6.println(F("but it expects uint8_t array of Serial6ised bytes in Flash"));
    Serial6.println(F(""));

    Serial6.println(F("Colour TFTs are natively big-endian"));
    Serial6.println(F("Many microcontrollers and Tools are little-endian"));
    Serial6.println(F("you can use the optional argument to select big-end"));
    tft.begin(ID);
