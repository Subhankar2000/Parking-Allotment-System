# 1 "D:\\Arduino-STM32-ARM-M4\\portable\\sketchbook\\libraries\\MCUFRIEND_kbv\\examples\\GLUE_Demo_480x320\\GLUE_Demo_480x320.ino"
# 1 "D:\\Arduino-STM32-ARM-M4\\portable\\sketchbook\\libraries\\MCUFRIEND_kbv\\examples\\GLUE_Demo_480x320\\GLUE_Demo_480x320.ino"
// UTFT_Demo_480x320 
...
# 21 "D:\\Arduino-STM32-ARM-M4\\portable\\sketchbook\\libraries\\MCUFRIEND_kbv\\examples\\GLUE_Demo_480x320\\GLUE_Demo_480x320.ino" 2
...
// Clear the screen and draw the frame
  ...
  myGLCD.print("* Universal Color TFT Display Library *", 9998, 1);
  myGLCD.setBackColor(64, 64, 64);
  myGLCD.setColor(255,255,0);
  myGLCD.print("<http://www.RinkyDinkElectronics.com/>", 9998, 307);
...
// Draw some random rounded rectangles
  ...
  myGLCD.setColor(255, 255, 255);
  myGLCD.setBackColor(255, 0, 0);
  myGLCD.print("That's it!", 9998, 93);
  myGLCD.print("Restarting in a", 9998, 119);
  myGLCD.print("few seconds...", 9998, 132);

  myGLCD.setColor(0, 255, 0);
  myGLCD.setBackColor(0, 0, 255);
  myGLCD.print("Runtime: (msecs)", 9998, 290);
  myGLCD.printNumI(millis(), 9998, 305);
